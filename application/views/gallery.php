<?php $this->load->view('common/header'); ?>
	<link href="<?php echo base_url(); ?>assets/css/gallery.css" rel="stylesheet" type="text/css" media="all" />
 		...
 		<!-- <div class="sap_tabs">	
 			<div id="horizontalTab">
 				<ul class="resp-tabs-list">
 					...
 					<li><span>Star Night</span></li>
 					<li><span>College Events</span></li>
		...
		<div class="portfolio w3layouts agileits" id="portfolio">
			<div class="container">
				...
				<ul class="simplefilter w3layouts agileits">
					...
					<li class="w3layouts agileits" data-filter="4">Star Night</li>
					<li class="w3layouts agileits" data-filter="5">Public Events</li>
					<li class="w3layouts agileits" data-filter="6">Product Launch</li>
					<!-- <li class="w3layouts agileits" data-filter="7">Exhibitions</li> -->
				</ul>
				...
				<div class="filtr-container w3layouts agileits">
					...
					<div class="filtr-item w3layouts agileits portfolio-t" data-category="1" data-sort="Busy streets">
						<a href="<?php echo base_url(); ?>assets/images/gallery/wedding.jpg" class="b-link-stripe w3layouts agileits b-animate-go thickbox">
							<figure>
								<img src="<?php echo base_url(); ?>assets/images/gallery/wedding.jpg" class="img-responsive w3layouts agileits" alt="Golive Photography">
								<figcaption>
									<h3>Wedding</h3>
								</figcaption>
							</figure>
					...
					<div class="filtr-item w3layouts agileits" data-category="3" data-sort="Luminous night">
						<a href="<?php echo base_url(); ?>assets/images/gallery/birthday/2nd-birthday.jpg" class="b-link-stripe w3layouts agileits b-animate-go thickbox">
							...
							<figure>
								<img src="<?php echo base_url(); ?>assets/images/gallery/birthday/2nd-birthday.jpg" class="img-responsive w3layouts agileits" alt="Golive Photography">
								<figcaption>
									<h3>Birthday</h3>
								</figcaption>
							</figure>
					...
					<div class="filtr-item w3layouts agileits" data-category="3" data-sort="Luminous night">
						<a href="<?php echo base_url(); ?>assets/images/gallery/birthday/Photography-43.jpg" class="b-link-stripe w3layouts agileits b-animate-go thickbox">
							...
							<figure>
								<img src="<?php echo base_url(); ?>assets/images/gallery/birthday/Photography-43.jpg" class="img-responsive w3layouts agileits" alt="Golive Photography">
								<figcaption>
									<h3>Birthday</h3>
								</figcaption>
							</figure>
					...
					<div class="filtr-item w3layouts agileits" data-category="2" data-sort="Peaceful lake">
						<a href="<?php echo base_url(); ?>assets/images/gallery/collegeevents/photographer-058.jpg" class="b-link-stripe w3layouts agileits b-animate-go thickbox">
							<figure>
								<img src="<?php echo base_url(); ?>assets/images/gallery/collegeevents/photographer-058.jpg" class="img-responsive w3layouts agileits" alt="Golive Photography">
								<figcaption>
									<h3>College Events</h3>
								</figcaption>
							</figure>
					...
					<div class="filtr-item w3layouts agileits" data-category="4" data-sort="City lights">
						<a href="<?php echo base_url(); ?>assets/images/gallery/starnight/W9BVsaw.jpg" class="b-link-stripe w3layouts agileits b-animate-go thickbox">
							<figure>
								<img src="<?php echo base_url(); ?>assets/images/gallery/starnight/W9BVsaw.jpg" class="img-responsive w3layouts agileits" alt="Golive Photography">
								<figcaption>
									<h3>Star night</h3>
								</figcaption>
							</figure>
					...
					<div class="filtr-item w3layouts agileits" data-category="5" data-sort="Dreamhouse">
						<a href="<?php echo base_url(); ?>assets/images/gallery/publicevents/Mardi-Gras-article.jpg" class="b-link-stripe w3layouts agileits b-animate-go thickbox">
							<figure>
								<img src="<?php echo base_url(); ?>assets/images/gallery/publicevents/Mardi-Gras-article.jpg" class="img-responsive w3layouts agileits" alt="Golive Photography">
								<figcaption>
									<h3>Public event</h3>
								</figcaption>
							</figure>
